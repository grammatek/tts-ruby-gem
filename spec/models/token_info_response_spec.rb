...
# Unit tests for GTTS::TokenInfoResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GTTS::TokenInfoResponse do
  let(:instance) { GTTS::TokenInfoResponse.new }

  describe 'test an instance of TokenInfoResponse' do
    it 'should create an instance of TokenInfoResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GTTS::TokenInfoResponse)
    end
  end

  describe 'test attribute "unix_timestamp"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "human_readable"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
